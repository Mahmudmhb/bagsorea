...
const BookingForm = () => {
  ...
  // const city = watch("city", "Dhaka"); // Default to Dhaka
  // const deliveryCharge = city === "Dhaka" ? 60 : 120;
  ...
  const cart = data?.filter((item: TBags) => item.id == Number(slug)) || [];

  const handleCourierrService = () => {
    const city = watch("city", "Dhaka"); // Default to Dhaka
    const deliveryCharge = city === "Dhaka" ? 60 : 120;
        ...
        <div className="max-w-5xl mx-auto p-6 bg-white mt-8 rounded-lg shadow-lg flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8">
          ...
          <div className="lg:w-1/2 mx-auto space-y-4">
                ...
                <Card key={item.id} className="border border-gray-200">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#030202]">Price: ${item.price}</p>
            ...
            <div className="flex flex-col space-y-3 items-center">
              <h3 className="font-semibold text-[#030202]">Total:</h3>
